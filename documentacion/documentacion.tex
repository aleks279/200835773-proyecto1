...
\begin{itemize}
  \item Se utiliz\'o el hosting service de Heroku para simular el ambiente de \emph{producci\'on} de este proyecto.
  \item La direcci\'on de dicha aplicaci\'on es \texttt{https://buy-sell-real-state.herokuapp.com/}
\end{itemize}
